...
let data_points = fs.readFileSync("fakeData/points.json", 'utf-8');
points_coll.insertMany(JSON.parse(data_points));

const orders_coll = getCollection("orders");
data = fs.readFileSync("fakeData/orders.json", 'utf-8');
